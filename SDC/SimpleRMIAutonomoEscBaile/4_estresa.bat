...
estresador %1 -Djava.rmi.server.codebase=file:%cb% -jar %cb% clienteescbaile.ClienteEscBaile localhost 200
goto fin

:consolicitudes
if [%3] NEQ [] goto conHost
estresador %1 -Djava.rmi.server.codebase=file:%cb% -jar %cb% clienteescbaile.ClienteEscBaile localhost %2
goto fin

:conHost
estresador %1 -Djava.rmi.server.codebase=file:///%cb% -jar %cb% clienteescbaile.ClienteEscBaile %3 %2
